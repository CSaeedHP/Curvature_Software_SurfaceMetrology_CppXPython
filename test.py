...
[user_min,user_max,min_scale] = userIO.get_user_range(input_array)

#analysis
start_time = time.time()

decimal_places = userIO.ask_trunkation()
...
if functionkey == "hybrid":
    ...
    XSC = analysis.parse_data(input_array,functionkey,user_min,user_max, decimal_places)
